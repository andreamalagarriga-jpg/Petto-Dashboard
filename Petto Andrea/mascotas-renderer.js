document.addEventListener('DOMContentLoaded', () => {
  ...
  function buildTableFromCards() {
    ...
    cards.forEach(card => {
      ...
      `;
      tr.addEventListener('click', () => window.location.href = 'mascota-detail.html?id=' + name.toLowerCase());
      tr.querySelector('.detail-link').addEventListener('click', e => { e.stopPropagation(); window.location.href = 'mascota-detail.html?id=' + name.toLowerCase(); });
  ...
  cards.forEach(card => {
    card.addEventListener('click', () => { const name = card.querySelector('.pet-card-name').textContent; window.location.href = 'mascota-detail.html?id=' + name.toLowerCase(); });
  });
